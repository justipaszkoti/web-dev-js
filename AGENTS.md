...
- **Never commit and push changes without explicit user permission.** This rule overrides any other behavior; always ask the user before creating a commit or pushing to the remote repository.
